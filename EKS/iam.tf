# IAM Role - EKS Master (Control Plane)
...
resource "aws_iam_role_policy_attachment" "master_vpc_controller" {
  policy_arn = "arn:aws:iam::aws:policy/AmazonEKSVPCResourceController"
  role       = aws_iam_role.master.name
}

# IAM Role - EKS Worker (Node Group)
...
# Autoscaler policy dla workerów
resource "aws_iam_policy" "autoscaler" {
  name_prefix = "eks-autoscaler-policy-"
  policy = jsonencode({
    Version = "2012-10-17"
    Statement = [{
      Effect = "Allow"
